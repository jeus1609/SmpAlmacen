...
namespace ModuloAlmacen.Formularios
{
    public partial class Interfaz : Form
    {
        ...
        DataSets.DS_AlmacenLocal dsAlmacen = new DataSets.DS_AlmacenLocal();
        DataSets.SIGADataSet dsSiga = new DataSets.SIGADataSet();

        DataSets.SIGADataSetTableAdapters.vListaPedidoDetalleTableAdapter adapListaPedidosDetalle = new DataSets.SIGADataSetTableAdapters.vListaPedidoDetalleTableAdapter();
        DataSets.SIGADataSetTableAdapters.vListaPedidosTableAdapter adapListaPedidos = new DataSets.SIGADataSetTableAdapters.vListaPedidosTableAdapter();

        DataSets.DS_AlmacenLocalTableAdapters.QuerysAdapter adapConsultarSiExiste = new DataSets.DS_AlmacenLocalTableAdapters.QuerysAdapter();
        DataSets.DS_AlmacenLocalTableAdapters.ENTRADATableAdapter adapEntrada = new DataSets.DS_AlmacenLocalTableAdapters.ENTRADATableAdapter();
        DataSets.DS_AlmacenLocalTableAdapters.ENTRADA_DETALLETableAdapter adapEntradaDetalle = new DataSets.DS_AlmacenLocalTableAdapters.ENTRADA_DETALLETableAdapter();
        DataSets.DS_AlmacenLocalTableAdapters.CATALOGO_BIENTableAdapter adapCatalogoBien = new DataSets.DS_AlmacenLocalTableAdapters.CATALOGO_BIENTableAdapter();
        DataSets.DS_AlmacenLocalTableAdapters.MOVIMIENTO_BIENTableAdapter adapMovimientoBien = new DataSets.DS_AlmacenLocalTableAdapters.MOVIMIENTO_BIENTableAdapter();
        ...
        private void btnImportar_Click(object sender, EventArgs e)
        {
            ...
            if (DialogResult.Yes == MessageBox.Show("Se Importaran " + ContadorImportacion + " PECOSA's\nEsta Operacion puede demorar si no tiene buena conexion a Internet\n Desea Continuar", "Informacion", MessageBoxButtons.YesNo, MessageBoxIcon.Information))
            {
                ...
                //try
                {
                    adapListaPedidosDetalle = new DataSets.SIGADataSetTableAdapters.vListaPedidoDetalleTableAdapter();
