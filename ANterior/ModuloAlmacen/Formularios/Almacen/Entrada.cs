...
namespace ModuloAlmacen.Formularios.Almacen
{
    ...
    {
        DataSets.DS_AlmacenLocal dsAlmacen;
        DataSets.DS_AlmacenLocalTableAdapters.vListaEntradaTableAdapter adapListaEntrada;
        ...
        private void ListarFiltro()
        {
            ...
            dsAlmacen = new DataSets.DS_AlmacenLocal();
            adapListaEntrada = new DataSets.DS_AlmacenLocalTableAdapters.vListaEntradaTableAdapter();

            adapListaEntrada.FillByFiltros(dsAlmacen.vListaEntrada, "%" + txtCodigo.Text + "%", "%" + txtDescItem.Text + "%", "%" + txtNroPecosa.Text + "%", "%" + txtNroPedido.Text + "%");
